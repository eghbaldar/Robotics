<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="News.aspx.vb" Inherits="News" title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                ...
                <tr>
                    <td style="text-align: left">
                        <asp:HyperLink ID="HyperLink1" runat="server" 
                            ...
                            style="font-family: Tahoma; font-size: 11px; color: #6CA5B7;text-decoration:none;">ادامه 
                        خبر ...</asp:HyperLink>
                    </td>
                </tr>
            </table>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [ID], [title_news], [lid_news] FROM [Tbl_News] WHERE ([Flag] = @Flag) ORDER BY [ID] DESC">
        <SelectParameters>
