<%@ Page Language="VB" MasterPageFile="~/Presentation/MP_Management.master" AutoEventWireup="false" CodeFile="News1.aspx.vb" Inherits="Presentation_CMS_News_News" title="Untitled Page" %>
                    ...
                    <tr>
                        <td style="text-align: center">
                            <asp:LinkButton ID="btn_showNews" runat="server" 
                                PostBackUrl="~/Presentation/CMS/News2/ShowNews.aspx">مشاهده خبر ها</asp:LinkButton>
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <tr>
                        <td style="text-align: center">
                            <asp:LinkButton ID="btn_insertNews" runat="server" 
                                PostBackUrl="~/Presentation/CMS/News2/Add_News.aspx">اضافه کردن خبر</asp:LinkButton>
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <tr>
                        <td class="style14">
                            <asp:LinkButton ID="btn_editNews" runat="server" 
                                PostBackUrl="~/Presentation/CMS/News2/Edit_News.aspx">ویرایش خبر ها</asp:LinkButton>
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <tr>
                        <td class="style14">
                            <asp:LinkButton ID="btn_groupNews" runat="server" 
                                PostBackUrl="~/Presentation/CMS/News2/Category_News.aspx">گروهبندی خبر ها</asp:LinkButton>
                        </td>
                    </tr>
                </table>
            </td>
