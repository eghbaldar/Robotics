                ...
                <table class="style5">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                            ...
                                            SelectCommand="SELECT * FROM [Tbl_TopicCategory] ORDER BY [Code_Category] DESC">
                                        </asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <asp:TemplateField HeaderText="وضعیت نمایش" SortExpression="flag">
                            ...
                            <HeaderStyle HorizontalAlign="Right" />                   
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                                        ConnectionString="<%$ ConnectionStrings:ModulesConnectionString %>" 
                                        SelectCommand="SELECT * FROM [Tbl_Topic] WHERE ([Code_Category] = @Code_Category) ORDER BY [ID] DESC">
                                        <SelectParameters>
                    ...
                    <tr>
                        ...
                        <asp:ObjectDataSource ID="ODS_News" runat="server" DeleteMethod="Delete" SelectMethod="SelectAll" 
                            TypeName="News2" OldValuesParameterFormatString="original_{0}">
                            <DeleteParameters>
                            ...
                            <table class="style5">
                                <tr>
                                    ...
                                    <asp:DropDownList ID="cmb_category_edit" runat="server" 
                                        ...
                                        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                            ...
                                            TypeName="News2"></asp:ObjectDataSource>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <FCKeditorV2:FCKeditor ID="txt_matnkotah_news_edit" runat="server" 
                                        BasePath="~/Content/fckeditor/" Width="700px"></FCKeditorV2:FCKeditor>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
